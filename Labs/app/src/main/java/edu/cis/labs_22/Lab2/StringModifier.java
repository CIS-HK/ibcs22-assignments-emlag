...
public class StringModifier
{
    /* TODO 2:
         ...
         e: Create a method that changes the first letter of
            ANY string to "yoink". So, "c.i.s." would turn into "yoink.i.s."
     */


    public String stringToUpperCase(String orig)
    {
        return "";
    }

    public String stringToLowerCase(String orig)
    {
        return "";
    }

    public String asToEs(String orig)
    {
        //for this question, you may expected only lower case inputs
        return "";
    }
    ...
    public String yoink(String orig)
    {
        return "";
    }
